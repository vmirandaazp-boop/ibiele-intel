    ...
    <div className="min-h-screen bg-slate-200 font-sans text-slate-900 border-[8px] md:border-[15px] border-[#003566]">
      ...
      <main className="max-w-7xl mx-auto p-3 md:p-6 space-y-6">
        ...
        {activeTab === "dashboard" && showInsights && sameDayEnero && (
          <section className="bg-[#001d3d] p-1 rounded-xl md:rounded-[40px] shadow-2xl border-2 border-slate-400 overflow-hidden animate-fade-in">
            <div className="bg-slate-800/50 p-4 md:p-6 flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <div className="w-full md:w-auto mt-4 md:mt-0">
                <div className="grid grid-cols-3 gap-2 md:gap-4">
                  <div className="bg-white/5 border border-white/10 p-3 md:p-4 rounded-xl md:rounded-2xl text-center">
                     ...
                     <p className="text-lg md:text-xl font-black text-blue-400">${sameDayEnero.revenue.toFixed(2)}</p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 md:p-4 rounded-xl md:rounded-2xl text-center">
                  ...
                  <div className="bg-white/5 border border-white/10 p-3 md:p-4 rounded-xl md:rounded-2xl text-center">
                     ...
                     <p className="text-lg md:text-xl font-black text-blue-400">+{sameDayEnero.followers}</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        {activeTab === "dashboard" && (
          <>
            ...
            <section className="grid grid-cols-1 gap-4 mb-6">
              <div className="bg-[#001d3d] p-4 md:p-8 rounded-xl md:rounded-[40px] shadow-2xl text-white border-2 border-slate-400">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-4">
                  <div className="text-center bg-white/5 p-3 md:p-5 rounded-lg md:rounded-2xl border border-white/10">
                    ...
                    <p className="text-xl md:text-4xl font-black text-blue-400">${eneroRevenue.toFixed(2)}</p>
                  </div>
                  <div className="text-center bg-white/5 p-3 md:p-5 rounded-lg md:rounded-2xl border border-white/10">
                    <p className="text-[7px] md:text-[10px] opacity-60 mb-1">VISUALIZACIONES</p>
                    <p className="text-xl md:text-4xl font-black text-blue-400">{eneroViews.toFixed(1)}M</p>
                  </div>
                  <div className="text-center bg-white/5 p-3 md:p-5 rounded-lg md:rounded-2xl border border-white/10">
                    <p className="text-[7px] md:text-[10px] opacity-60 mb-1">SEGUIDORES</p>
                    <p className="text-xl md:text-4xl font-black text-blue-400">{(eneroFollowers/1000).toFixed(1)}K</p>
                  </div>
                  <div className="text-center bg-white/5 p-3 md:p-5 rounded-lg md:rounded-2xl border border-white/10">
                    <p className="text-[7px] md:text-[10px] opacity-60 mb-1">CONVERSIÓN</p>
                    <p className="text-xl md:text-4xl font-black text-blue-400">{conversionRate.toFixed(0)}/M</p>
                  </div>
                </div>
                
                <div className="mt-4 md:mt-6 p-3 md:p-4 bg-blue-400/10 rounded-lg md:rounded-xl border border-blue-400/30">
                  <p className="text-[7px] md:text-[10px] font-bold text-blue-300 uppercase">Mejor día: {bestDay.date.split("-").reverse().join("/")}</p>
                  <p className="text-base md:text-xl font-black mt-1 text-blue-400">${bestDay.revenue.toFixed(2)} • {bestDay.views}M vistas</p>
              ...
              <div className="bg-[#001d3d] p-4 md:p-8 rounded-xl md:rounded-[40px] shadow-2xl text-white border-2 border-slate-400">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-4">
                  <div className="text-center bg-white/5 p-3 md:p-5 rounded-lg md:rounded-2xl border border-white/10">
                    <p className="text-[7px] md:text-[10px] opacity-60 mb-1">INGRESOS</p>
                    <p className="text-xl md:text-4xl font-black text-blue-400">${totalRevenue.toFixed(2)}</p>
                  </div>
                  <div className="text-center bg-white/5 p-3 md:p-5 rounded-lg md:rounded-2xl border border-white/10">
                    <p className="text-[7px] md:text-[10px] opacity-60 mb-1">VISUALIZACIONES</p>
                    <p className="text-xl md:text-4xl font-black text-blue-400">{(totalViews/1000000).toFixed(1)}M</p>
                  </div>
                  <div className="text-center bg-white/5 p-3 md:p-5 rounded-lg md:rounded-2xl border border-white/10">
                    <p className="text-[7px] md:text-[10px] opacity-60 mb-1">PROMEDIO DIARIO</p>
                    <p className="text-xl md:text-4xl font-black text-blue-400">${avgRevenue.toFixed(2)}</p>
                  </div>
                  <div className="text-center bg-white/5 p-3 md:p-5 rounded-lg md:rounded-2xl border border-white/10">
                    <p className="text-[7px] md:text-[10px] opacity-60 mb-1">META DIARIA</p>
                    <p className="text-xl md:text-4xl font-black text-blue-400">${dailyTarget.toFixed(2)}</p>
                  </div>
                </div>
                ...
                <div className="mt-4 md:mt-6">
                  ...
                  <div className="w-full bg-white/10 rounded-full h-2 md:h-4 overflow-hidden">
                    <div 
                      className="bg-gradient-to-r from-blue-400 to-blue-600 h-2 md:h-4 rounded-full transition-all duration-700"
                      style={{ width: `${Math.min((totalRevenue/1250)*100, 100)}%` }}
                    ></div>
                  </div>
                  <p className="text-[8px] md:text-sm text-center mt-2 font-bold text-blue-400">
            ...
            <section className="bg-white rounded-xl md:rounded-[40px] shadow-xl p-4 md:p-8 border-2 border-slate-300 mb-6">
              ...
              <div className="grid grid-cols-1 gap-4">
                {topPerformers.map((item, idx) => (
                  <div key={idx} className={`p-3 md:p-6 rounded-lg md:rounded-2xl border-l-3 md:border-l-4 ${
                    ...
                    idx === 1 ? 'border-blue-400 bg-blue-50' : 'border-blue-300 bg-blue-50'
                  }`}>
                    <div className="flex justify-between items-start mb-3 md:mb-4">
                      <div className="text-xl md:text-3xl font-black text-[#003566]">{idx + 1}</div>
                    ...
                    <div className="grid grid-cols-2 gap-2 md:gap-3 mt-3 md:mt-4">
                      <div className="text-center p-2 md:p-3 bg-slate-100 rounded-lg">
                        ...
                        <p className="font-black text-[10px] md:text-base text-[#003566]">{item.views}M</p>
                      </div>
                      <div className="text-center p-2 md:p-3 bg-slate-100 rounded-lg">
                        <p className="text-[7px] md:text-[10px] font-bold text-slate-500">Fecha</p>
                        <p className="font-black text-[10px] md:text-base text-[#003566]">{item.date.split("-").reverse().join("/")}</p>
                      </div>
                    </div>
                  </div>
                ))}
              ...
              <div className="mt-4 md:mt-8 p-3 md:p-6 bg-blue-50 rounded-lg md:rounded-2xl border border-blue-200">
                <div className="flex items-start">
                  <div className="text-2xl md:text-4xl mr-2 md:mr-4 mt-1 text-blue-600">💡</div>
                  <div>
                    <h3 className="font-black text-sm md:text-lg text-[#003566] mb-1 md:mb-2">PATRÓN DETECTADO</h3>
                    <p className="text-[8px] md:text-sm text-slate-700">
            ...
            <section className={`p-4 md:p-8 rounded-xl md:rounded-[40px] shadow-xl border-4 ${
              ...
              <form onSubmit={saveData} className="space-y-3">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  <div className="space-y-1">
                    ...
                    <input 
                      ...
                      className="w-full p-2 md:p-4 rounded-lg md:rounded-2xl bg-slate-50 border-2 font-bold text-sm md:text-base outline-none focus:border-[#003566] focus:ring-2 focus:ring-blue-200"
                      required
                    />
                  </div>
                  <div className="space-y-1">
                    ...
                    <input 
                      ...
                      className="w-full p-2 md:p-4 rounded-lg md:rounded-2xl bg-slate-50 border-2 font-bold text-sm md:text-base outline-none focus:border-blue-500"
                      required
                    />
                  </div>
                  <div className="space-y-1">
                    ...
                    <input 
                      ...
                      className="w-full p-2 md:p-4 rounded-lg md:rounded-2xl bg-green-50 border-2 border-green-200 font-black text-green-700 outline-none focus:border-green-500 text-sm md:text-base"
                      required
                    />
                  </div>
                  <div className="md:col-span-2 space-y-1">
                    ...
                    <input 
                      ...
                      className="w-full p-2 md:p-4 rounded-lg md:rounded-2xl bg-slate-50 border-2 font-bold uppercase outline-none focus:border-blue-500 text-[8px] md:text-base"
                      required
                    />
                  </div>
                  <div className="space-y-1">
                    ...
                    <select 
                      ...
                      className="w-full p-2 md:p-4 rounded-lg md:rounded-2xl bg-slate-50 border-2 font-bold outline-none focus:border-blue-500 text-sm md:text-base"
                    >
                ...
                <button 
                  type="submit" 
                  className="w-full bg-[#003566] text-white p-3 md:p-6 rounded-xl md:rounded-[35px] font-black text-base md:text-2xl shadow-xl hover:bg-slate-800 active:scale-95 transition-all transform italic"
                >
                  {editingId ? "ACTUALIZAR REGISTRO 🔄" : "SINCRONIZAR IMPERIO 🚀"}
                </button>
              </form>
            </section>

            {/* BITÁCORA CON EDICIÓN */}
            <section className="bg-white rounded-xl md:rounded-[40px] shadow-2xl p-4 md:p-8 border-2 border-slate-300">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 md:mb-8 gap-3">
                <h2 className="text-xl md:text-3xl font-black text-[#003566] uppercase italic tracking-tighter">Historial Febrero</h2>
              ...
              <div className="space-y-3">
                {filteredData.map((item) => (
                  <div 
                    ...
                    className="flex flex-col md:flex-row justify-between items-start md:items-center p-4 bg-slate-50 rounded-2xl border border-slate-200 hover:bg-blue-50 cursor-pointer transition-all group"
                  >
                    ...
                    <div className="flex items-center gap-4 w-full md:w-auto justify-between md:justify-end">
                      ...
                      <div className="flex items-center gap-2">
                        <button 
                          ...
                          className="text-blue-600 hover:text-blue-800 text-lg md:text-xl"
                          title="Editar"
                        >
                          ✏️
                        </button>
                ...
                {filteredData.length === 0 && (
                  <div className="p-8 text-center text-[8px] md:text-sm text-slate-400 italic bg-slate-50 rounded-2xl">
        ...
        {activeTab === "audiencia" && (
          <section className="space-y-6">
            ...
            {/* RANGO DE EDAD */}
            <div className="bg-[#001d3d] p-4 md:p-8 rounded-xl md:rounded-[40px] shadow-xl text-white border-2 border-slate-400">
              <div className="flex items-center mb-4 md:mb-6">
                <div className="text-3xl md:text-5xl mr-2 md:mr-4">🎂</div>
                <h2 className="text-lg md:text-2xl font-black uppercase text-blue-400">EDAD</h2>
              </div>
              
              <div className="space-y-3">
                {DEMOGRAPHICS.age.map((item, idx) => (
                  <div key={idx} className={`p-3 md:p-4 rounded-lg md:rounded-2xl ${
                    item.highlight ? 'bg-white/5 border border-blue-400' : 'bg-white/5'
                  }`}>
                    <div className="flex justify-between mb-1 md:mb-2">
                      <span className="font-bold text-[8px] md:text-sm">{item.range}</span>
                      <span className={`font-black text-[10px] md:text-base ${item.highlight ? 'text-blue-400' : 'text-slate-400'}`}>{item.percent}%</span>
                    </div>
                    <div className="w-full bg-white/10 rounded-full h-1.5 md:h-3">
                      <div 
                        className={`h-1.5 md:h-3 rounded-full ${item.highlight ? 'bg-blue-400' : 'bg-slate-400'} transition-all duration-700`}
                  ...
                  <div key={idx} className="flex items-center">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex justify-between mb-1">
                        ...
                        <span className="font-black text-[10px] md:text-base text-[#003566]">{country.percent}%</span>
                      </div>
                      <div className="w-full bg-slate-200 rounded-full h-1.5 md:h-3">
                        <div 
                          className="bg-gradient-to-r from-blue-500 to-blue-700 h-1.5 md:h-3 rounded-full"
              ...
              {Object.entries(FORMAT_STATS).map(([format, stats], idx) => (
                <div key={idx} className={`${stats.color} p-4 md:p-8 rounded-xl md:rounded-[40px] shadow-2xl text-white`}>
                  <div className="text-4xl md:text-6xl mb-2 md:mb-4">
                    {format === "Foto" ? "📸" : format === "Reels" ? "🎬" : "📱"}
                  </div>
                  <h3 className="text-lg md:text-2xl font-black mb-2">{format.toUpperCase()}</h3>
        ...
        {activeTab === "historico" && (
          <section className="space-y-6">
            ...
            <div className="bg-[#001d3d] p-4 md:p-8 rounded-xl md:rounded-[40px] shadow-2xl text-white border-2 border-slate-400 mb-6">
              <div className="text-center">
                <div className="text-4xl md:text-8xl font-black mb-2 md:mb-4 text-blue-400">${eneroRevenue.toFixed(2)}</div>
                <h2 className="text-lg md:text-3xl font-black mb-2 md:mb-3 uppercase">INGRESOS TOTALES</h2>
                <p className="text-[8px] md:text-xl mb-3 md:mb-6 opacity-90">{eneroViews.toFixed(1)}M vistas • {(eneroFollowers/1000).toFixed(1)}K seguidores</p>
                <div className="grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-8 text-center">
                  <div className="p-2 md:p-4">
                    <p className="text-[7px] md:text-sm opacity-90">RPM PROMEDIO</p>
                    <p className="text-lg md:text-3xl font-black text-blue-400">${(eneroRevenue/eneroViews).toFixed(2)}</p>
                  </div>
                  <div className="p-2 md:p-4">
                    <p className="text-[7px] md:text-sm opacity-90">MEJOR DÍA</p>
                    <p className="text-lg md:text-3xl font-black text-blue-400">${bestDay.revenue.toFixed(0)}</p>
                  </div>
                  <div className="p-2 md:p-4">
                    <p className="text-[7px] md:text-sm opacity-90">CONVERSIÓN</p>
                    <p className="text-lg md:text-3xl font-black text-blue-400">{conversionRate.toFixed(0)}/M</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl md:rounded-[40px] shadow-2xl p-4 md:p-8 border-2 border-slate-300">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 md:mb-8 gap-3">
                <h2 className="text-xl md:text-3xl font-black text-[#003566] uppercase italic tracking-tighter">Registro Completo Enero</h2>
                <div className="text-[8px] md:text-sm text-slate-500 text-right">
                  ...
                  <table className="w-full text-left">
                    <thead>
                      <tr className="text-[#003566] text-[7px] md:text-[10px] font-black uppercase bg-slate-50">
                        ...
                        <th className="p-2 md:p-4">Seguidores</th>
                      </tr>
                    </thead>
